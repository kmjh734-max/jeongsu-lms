...
export const spec: SetSpec = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ["$98.40", "$108.00", "$113.00", "$123.00", "$153.00"],
      answer: 2,
    ...
    },
    {
      ...
      table: {
        rows: [
          ...
          { no: 3, label: "③", value: "Size: 1.7 L / Keep-warm: Yes / Price: 68,000 won" },
          { no: 4, label: "④", value: "Size: 1.5 L / Keep-warm: Yes / Price: 47,000 won" },
    ...
    },
    {
      ...
      explanation:
        "남자가 실험실 문에 붙은 당번표를 지나갈 때 보라고 했으므로, 그렇게 하겠다는 ②가 가장 자연스럽다.",
      translation: [
    ...
    },
    {
      ...
      explanation:
        "남자가 네 번째 판본을 인쇄해 복도에 붙여 보라고 했으므로, 오늘 밤 붙여 보겠다는 ①이 가장 자연스럽다.",
      translation: [
    ...
    },
    {
      ...
      explanation:
        "여자가 문 옆에 바나나를 두고 나가면서 하나 먹으라고 했으므로, 내일 나가면서 하나 챙기겠다는 ①이 가장 자연스럽다.",
      translation: [
