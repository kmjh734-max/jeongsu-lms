...
export const spec: SetSpec = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ["여는 날", "여는 장소", "파는 물건", "앉을 자리", "주차 방법"],
      answer: 5,
    ...
    },
    {
      ...
      table: {
        rows: [
          ...
          { no: 3, label: "③", value: "Capacity: 8 / Shower nearby: Yes / Price: 75,000 won per night" },
          { no: 4, label: "④", value: "Capacity: 10 / Shower nearby: Yes / Price: 58,000 won per night" },
    ...
    },
    {
      ...
      explanation:
        "남자가 사무실에 여벌 열쇠가 있으니 서명하고 받으라고 했으므로, 내일 서명하고 받겠다는 ②가 가장 자연스럽다.",
      translation: [
        "W: 태윤아, 동아리방 열쇠 반납됐어?",
    ...
    },
    {
      ...
      explanation:
        "여자가 금요일에 돌아가서 제안받은 자리에 앉으라고 했으므로, 이번 금요일에 돌아가겠다는 ③이 가장 자연스럽다.",
      translation: [
    ...
    },
    {
      ...
      explanation:
        "남자가 사과를 빼고 바로 질문하라고 했으므로, 다음부터 사과를 빼겠다는 ①이 가장 자연스럽다.",
      translation: [
    ...
    },
    {
      ...
      explanation:
        "준이는 모든 실험에 같은 숟가락을 쓰고 표를 다시 채우자고 말하려 하므로 ②가 가장 적절하다.",
      translation: [
