...
export const spec: SetSpec = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ["$170.00", "$204.00", "$210.00", "$240.00", "$270.00"],
      answer: 3,
    ...
    },
    {
      ...
      explanation:
        "자전거는 보행교 아래 구간에서만 탈 수 있다고 했으므로 전 구간이라는 ④는 내용과 다르다. 따라서 답은 ④이다.",
      translation: [
    ...
    },
    {
      ...
      table: {
        rows: [
          { no: 1, label: "①", value: "Adjustable: No / Folds flat: Yes / Price: 15,000 won" },
          { no: 2, label: "②", value: "Adjustable: Yes / Folds flat: Yes / Price: 27,000 won" },
    ...
    },
    {
      ...
      explanation:
        "남자가 시험 시간대에 해당하는 두 시간은 헤드폰을 벗고 공부하라고 했으므로, 그렇게 하겠다는 ①이 가장 자연스럽다.",
      translation: [
    ...
    },
    {
      ...
      explanation:
        "아름이는 무거운 상자를 더 작은 상자로 나누자고 말하려 하므로 ⑤가 가장 적절하다.",
      translation: [
