...
export const spec: SetSpec = {
  ...
  questions: [
    ...
    },
    {
      ...
      choices: ["$108.00", "$102.00", "$120.00", "$132.60", "$156.00"],
      answer: 2,
    ...
    },
    {
      ...
      choices: ["운영 기간", "장소", "인솔 교사", "하는 일", "준비물"],
      answer: 3,
    ...
    },
    {
      ...
      explanation:
        "언덕 위에는 주차할 수 없고 아래 주차장에서 걸어 올라온다고 했으므로 ①은 내용과 다르다. 따라서 답은 ①이다.",
      translation: [
    ...
    },
    {
      ...
      table: {
        rows: [
          ...
          { no: 3, label: "③", value: "Format: Live / Graded work: Yes / Fee: 120,000 won" },
          { no: 4, label: "④", value: "Format: Live / Graded work: Yes / Fee: 75,000 won" },
    ...
    },
    {
      ...
      explanation:
        "남자가 다음 시간을 예약해 막연한 방향이라도 말해 보라고 했으므로, 이번 주로 예약하겠다는 ③이 가장 자연스럽다.",
      translation: [
