/** Bump when shuffle / split / pin rules change (invalidates deterministic seeds). */
export const SENTENCE_ORDER_ALGORITHM_VERSION = "sentence-order-v1";
...
/** Labels for shuffled choices (screen order, not original order). */
export const SENTENCE_ORDER_LABELS = [
  "A",
  "B",
  "C",
  "D",
