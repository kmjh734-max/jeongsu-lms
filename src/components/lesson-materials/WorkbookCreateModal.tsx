...
const WORKBOOK_SESSION_KEY = "lesson-materials-workbook-v1";

export function saveWorkbookToSession(workbook: unknown) {
  try {
...
export function loadWorkbookFromSession<T = unknown>(): T | null {
  try {
